# ParentNinja — AI Context

This is the **parent-facing** section of the Ninja Learning App.
It covers parent dashboards, student progress visibility, notifications, and family profile management.
...
- **Parent** (this folder) — Progress visibility, notifications, family management

The core cross-section data flow: Instructor grades a student → Student Profile updates (belt, stripes) → Parent is notified. This section is the downstream receiver — it displays grading updates, triggers challenge flows, and surfaces student progress to families.
...
Work in this folder relates only to parent-facing UI and prototypes.
