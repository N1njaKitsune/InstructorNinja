...
2. **Read the Working Doc** — check `_WORKING_DOCS/NinjaLearning_WorkingDoc_v2.0.md` for current schema decisions and the deliverables tracker.
...
6. **Save to** `Stage-1_Dojo-Portal/Schema-Deliverables/`.
