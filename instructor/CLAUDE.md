...
Cross-section interactions (grading pushes that update student profiles and trigger parent notifications)
are documented in `../_SHARED/integration/` and `../_MASTER/ARCHITECTURE.md`.
