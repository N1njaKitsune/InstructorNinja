...
This `_MASTER` directory is the organisational scaffold. It tells each Claude agent which department it belongs to, what tools it has, who it reports to, and how it fits into the wider team. It sits alongside the project — not inside any phase.
...
All non-negotiable rules from `_MASTER/CLAUDE.md` apply across every department. The most critical:
