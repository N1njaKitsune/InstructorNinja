...
- **Landscape-first** for all screens (especially Nendō, which is landscape-only per non-negotiable rule #18)
...
:root {
  ...
  /* Dark theme (student profile, Nendō) */
...
- Dark backgrounds (`#061006` family) for student-facing screens and Nendō
...
- `Nendo_[ScreenName]_v[X.Y].html` — Stage 2 prototypes

Version numbers are included when iterating: `_v1.0`, `_v1.3`, `_v4.0`, etc.

### File Locations

- Stage 1 prototypes → `student/prototypes/`
- Stage 2 prototypes → `student/prototypes/`
...
If building a Nendō prototype, these non-negotiable rules apply:
...
- [ ] Correct colour variables used (dark for student/Nendō, light for parent/admin)
...
- `student/prototypes/NinjaLearning_StudentProfile.html` — student-facing, dark theme, landscape
- `student/prototypes/NinjaLearning_ParentApp_v1.3.html` — parent-facing
- `student/prototypes/NinjaLearning_InstructorApp_v4.0.html` — instructor-facing
- `student/prototypes/Nendo_AuraProgression_v1.0.html` — Nendō, landscape-only
